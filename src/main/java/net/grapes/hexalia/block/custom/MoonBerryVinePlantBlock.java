...
public class MoonBerryVinePlantBlock extends CaveVinesBodyBlock {
    ...
    public MoonBerryVinePlantBlock(Settings settings) {
        super(settings);
    }

    @Override
    protected AbstractPlantStemBlock getStem() {
        return (AbstractPlantStemBlock) ModBlocks.MOON_BERRIES_VINE;
    }
