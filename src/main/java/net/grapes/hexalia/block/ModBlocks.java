...
public class ModBlocks {
    ...
    public static final Block DREAMSHROOM = registerBlock("dreamshroom",
            new HexMushroomBlock(FabricBlockSettings.copyOf(Blocks.BROWN_MUSHROOM).luminance(4).nonOpaque().noCollision()));
    ...
    public static final Block FERAL_SUNFIRE_TOMATO = registerBlock("feral_sunfire_tomato",
            new FeralSunfireTomato(FabricBlockSettings.copyOf(Blocks.CORNFLOWER).luminance(8).nonOpaque()));
    ...
    public static void registerModBlocks() {
        HexaliaMod.LOGGER.info("Registering ModBlocks for " + HexaliaMod.MOD_ID);
    }
}