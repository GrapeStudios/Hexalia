...
public class ModFoodProperties {
    ...
    public static final FoodProperties CHILLBERRIES = new FoodProperties.Builder().nutrition(2).saturationMod(0.3f).build();
    ...
    public static final FoodProperties SUNFIRE_TOMATO = new FoodProperties.Builder().nutrition(1).saturationMod(0.3f).build();
    ...
    public static final FoodProperties WITCH_SALAD = new FoodProperties.Builder().nutrition(6).saturationMod(0.6f)
            .effect(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 600), 1.0f)
            .effect(() -> new MobEffectInstance(ModMobEffects.OVERFED.get(), 600), 1.0f)
