...
public class PhantomDriftEffect implements ICenserEffect {
    ...
    private static final Direction[] SEARCH_DIRECTIONS = new Direction[]{null, Direction.UP, Direction.DOWN, Direction.NORTH};
    ...
    public void onTick(ServerWorld world, BlockPos pos) {
        ...
        List<ItemEntity> items = world.getEntitiesByClass(ItemEntity.class, area, entity -> !entity.isRemoved());
    ...
    private static void tryPhaseIntoContainer(ServerWorld world, ItemEntity itemEntity, List<BlockPos> containerPositions) {
        BlockPos itemPos = itemEntity.getBlockPos();
        containerPositions.sort(Comparator.comparingDouble(pos -> pos.getSquaredDistance(itemPos)));
        ...
        for (BlockPos containerPos : containerPositions) {
            ...
            remaining = insertItemStacked(storage, remaining);
    ...
    private static ItemStack insertItemStacked(Storage<ItemVariant> storage, ItemStack stack) {
