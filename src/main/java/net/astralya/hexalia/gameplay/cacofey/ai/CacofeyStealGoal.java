...
public class CacofeyStealGoal extends Goal {
    ...
    public void start() {
        ...
        cacofey.getWorld().playSound(null,
    ...
    private void tickApproach() {
        ...
        cacofey.getLookControl().lookAt(target, 30F, 30F);
    ...
    private void tickFlee() {
        Vec3d awayDir = cacofey.getPos().subtract(
                target != null ? target.getPos() : cacofey.getPos()
    ...
    private boolean findTarget() {
        List<PlayerEntity> players = cacofey.getWorld().getEntitiesByClass(PlayerEntity.class,
    ...
    private static ItemStack findEdibleItem(PlayerEntity player) {
        for (int i = 0; i < player.getInventory().size(); i++) {
            ...
            if (stack.getComponents().contains(net.minecraft.component.DataComponentTypes.FOOD)) return stack;
        }
