...
public class RitualTableRecipeBuilder implements RecipeBuilder {
    ...
    public RitualTableRecipeBuilder(List<ItemLike> ingredients, ItemLike input, ItemLike output) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public void serializeRecipeData(JsonObject pJson) {
            pJson.addProperty("type", "hexalia:ritual_table");
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(HexaliaMod.MODID, ForgeRegistries.ITEMS.getKey(this.output).getPath() + "_from_ritual_table");
        }
