...
public final class RitualTableEmiRecipe implements EmiRecipe {
    ...
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(HexaliaMod.MODID, "textures/gui/ritual_table_gui.png");

    private final RecipeHolder<RitualTableRecipe> entry;
    private final List<EmiIngredient> inputs;
    private final List<EmiStack> outputs;

    public RitualTableEmiRecipe(RecipeHolder<RitualTableRecipe> entry) {
        this.entry = entry;
