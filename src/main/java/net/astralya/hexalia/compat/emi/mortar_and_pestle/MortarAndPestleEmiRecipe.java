...
public final class MortarAndPestleEmiRecipe implements EmiRecipe {
    ...
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(HexaliaMod.MODID, "textures/gui/mortar_gui.png");

    private final RecipeHolder<MortarAndPestleRecipe> entry;
    private final List<EmiIngredient> inputs;
    private final List<EmiStack> outputs;

    public MortarAndPestleEmiRecipe(RecipeHolder<MortarAndPestleRecipe> entry) {
        this.entry = entry;
