...
public final class SmallCauldronCategory implements DisplayCategory<SmallCauldronDisplay> {
    ...
    public static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HexaliaMod.MODID, "textures/gui/category/small_cauldron_gui.png");

    public static final CategoryIdentifier<SmallCauldronDisplay> SMALL_CAULDRON =
            CategoryIdentifier.of(ResourceLocation.fromNamespaceAndPath(HexaliaMod.MODID, "small_cauldron"));
