...
public class GrimshadeBlock extends EnchantedPlantBlock implements net.minecraft.block.BlockEntityProvider {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (held.getItem() != ModItems.HEX_FOCUS) return ActionResult.PASS;
        if (!world.isClient) {
    ...
    private void playActivationEffects(ServerWorld world, BlockPos pos) {
        ...
        world.playSound(null, pos, SoundEvents.PARTICLE_SOUL_ESCAPE, SoundCategory.BLOCKS, 0.8f, 1.0f);
