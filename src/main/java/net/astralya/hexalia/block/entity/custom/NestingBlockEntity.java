...
public class NestingBlockEntity extends BlockEntity implements Inventory, ExtendedScreenHandlerFactory {
    ...
    public float getOpenProgress(float partialTick) {
        return MathHelper.lerp(partialTick, openProgressOld, openProgress);
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, NestingBlockEntity blockEntity) {
        blockEntity.onSyncedBlockEvent(1, blockEntity.openCount);
    }

    public static void clientTick(World world, BlockPos pos, BlockState state, NestingBlockEntity blockEntity) {
        ...
        blockEntity.openProgress = MathHelper.clamp(blockEntity.openProgress, 0.0F, 1.0F);
    }
