package net.astralya.hexalia.world;

import net.astralya.hexalia.HexaliaMod;
import net.astralya.hexalia.block.ModBlocks;
import net.astralya.hexalia.block.custom.ChillberryBushBlock;
import net.astralya.hexalia.world.gen.decorator.CatkinTreeDecorator;
import net.astralya.hexalia.world.gen.decorator.CocoonTreeDecorator;
...
public class ModConfiguredFeatures {
    ...
    public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, new Identifier(HexaliaMod.MODID, name));
