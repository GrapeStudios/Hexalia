package net.astralya.hexalia.entity.custom.boat;
...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        switch (getModVariant()) {
            case COTTONWOOD -> {
                return ModItems.COTTONWOOD_BOAT.get();
            }
            case WILLOW -> {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.COTTONWOOD.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, COTTONWOOD);
        }
    }
}
