...
public class SmallCauldronBlockEntityRenderer implements BlockEntityRenderer<SmallCauldronBlockEntity> {
    ...
    private float computeSwirlAngleRad(SmallCauldronBlockEntity be, Level level, float partialTicks) {
        ...
        float maxVel = 0.12F;
        if (s.velRadPerTick > maxVel) s.velRadPerTick = maxVel;
        if (s.velRadPerTick < -maxVel) s.velRadPerTick = -maxVel;
    ...
    private void renderLiquid(SmallCauldronBlockEntity be, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        ...
        consumer.addVertex(mat, LIQUID_MIN_X, height, LIQUID_MIN_Z)
                .setColor(r, g, b, a)
                .setUv(u0, v0)
                .setOverlay(overlay)
        ...
        consumer.addVertex(mat, LIQUID_MIN_X, height, LIQUID_MAX_Z)
                .setColor(r, g, b, a)
                .setUv(u0, v1)
                .setOverlay(overlay)
                .setLight(packedLight)
        ...
        consumer.addVertex(mat, LIQUID_MAX_X, height, LIQUID_MAX_Z)
                .setColor(r, g, b, a)
                .setUv(u1, v1)
                .setOverlay(overlay)
                .setLight(packedLight)
        ...
        consumer.addVertex(mat, LIQUID_MAX_X, height, LIQUID_MIN_Z)
                .setColor(r, g, b, a)
                .setUv(u1, v0)
                .setOverlay(overlay)
                .setLight(packedLight)
