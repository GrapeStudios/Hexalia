...
public class BloomwrapRobesItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public BloomwrapRobesItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(
                ...
                if (renderer == null) {
                    renderer = new BloomwrapRobesRenderer();
                }
                return renderer;
            }
        });
