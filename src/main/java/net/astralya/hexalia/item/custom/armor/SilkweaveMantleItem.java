...
public class SilkweaveMantleItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public SilkweaveMantleItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
