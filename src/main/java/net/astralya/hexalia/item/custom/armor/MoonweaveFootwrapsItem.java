...
public class MoonweaveFootwrapsItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public MoonweaveFootwrapsItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> net.minecraft.client.render.entity.model.BipedEntityModel<?> getGeoArmorRenderer(
                ...
                if (renderer == null) {
                    renderer = new MoonweaveFootwrapsRenderer();
                }
                return renderer;
            }
        });
