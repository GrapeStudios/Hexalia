...
public class SilkweaveBindingsItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public SilkweaveBindingsItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
