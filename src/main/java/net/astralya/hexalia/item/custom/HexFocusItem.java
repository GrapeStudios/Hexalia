...
public class HexFocusItem extends Item {
    ...
    public static void attuneToEntity(net.minecraft.world.item.ItemStack stack, UUID uuid) {
    ...
    public static boolean hasAttunedCacofey(net.minecraft.world.item.ItemStack stack) {
        CustomData data = stack.get(DataComponents.CUSTOM_DATA);
        if (data == null) return false;
        return data.copyTag().hasUUID(TAG_CACOFEY_UUID);
    }

    public static UUID getAttunedUUID(net.minecraft.world.item.ItemStack stack) {
        CustomData data = stack.get(DataComponents.CUSTOM_DATA);
    ...
    private static void clearAttunedUUID(net.minecraft.world.item.ItemStack stack) {
        CustomData data = stack.get(DataComponents.CUSTOM_DATA);
        if (data == null) return;
        CompoundTag tag = data.copyTag();
