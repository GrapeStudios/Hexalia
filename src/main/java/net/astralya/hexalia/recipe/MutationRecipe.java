...
public final class MutationRecipe implements Recipe<SimpleInventory> {

    private final Identifier id;
    private final Ingredient inputItem;
    private final ItemStack output;

    public MutationRecipe(Identifier id, Ingredient inputItem, ItemStack output) {
        this.id = id;
    ...
    public static final class Serializer implements RecipeSerializer<MutationRecipe> {
        ...
        public MutationRecipe read(Identifier id, JsonObject json) {
            ...
            return new MutationRecipe(id, input, out);
        }
