...
public class CacofeyAnchorHoverGoal extends Goal {
  ...
  public void tick() {
    ...
    double targetX =
        anchor.getX() + cacofey.getRandom().nextIntBetweenInclusive(-HOVER_RADIUS, HOVER_RADIUS);
    double targetY = anchor.getY() + HOVER_Y_OFFSET + cacofey.getRandom().nextInt(2);
    double targetZ =
        anchor.getZ() + cacofey.getRandom().nextIntBetweenInclusive(-HOVER_RADIUS, HOVER_RADIUS);
